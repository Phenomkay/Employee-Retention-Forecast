...
if st.button("Predict", key="predict_button"):
    ...
    input_scaled = pd.DataFrame(input_scaled_array, columns=feature_columns)
    ...
    try:
        ...
        prediction_proba = 0.0  # Fallback if model doesn't support predict_proba or class '1' not present
