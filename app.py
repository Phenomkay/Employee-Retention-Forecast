...
scaler_features = joblib.load("scaler_features.pkl") # Load the scaler features
...
if st.button("Predict", key="predict_button"):
    ...
    st.write("Features the scaler was trained on:", scaler_features)
    st.write("Columns in input_data before reordering:", input_data.columns.tolist())

    # === Ensure Column Order Before Scaling ===
    input_data = input_data[feature_columns]

    st.write("Columns in input_data after reordering:", input_data.columns.tolist())
